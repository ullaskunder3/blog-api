...
In our [last post](/data/posts/what-is-a-tree-in-dsa.mdx), we built a network of friends connected by ropes. But what if you need to deliver a message to *everyone* in that network? If you just run around randomly, you'll likely visit some people three times and miss others entirely.
